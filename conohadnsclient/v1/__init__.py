...
from conohadnsclient import exceptions
from conohadnsclient import utils
from conohadnsclient import version
...
class Client(object):
    ...
    def __init__(self, endpoint=None, username=None, user_id=None,
        ...
        self.session = utils.AdapterWithTimeout(
            ...
            interface=interface,
            user_agent='python-conohadnsclient-%s' % version.version_info,
            version='1',
            timeout=timeout,
        )
        ...
        mgr = extension.ExtensionManager('conohadnsclient.v1.controllers')
